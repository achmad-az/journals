...
$includes = array(
	'lib/inc/class-journals-wrapping.php', // Theme wrapper class.
...
foreach ( $includes as $file ) {
	...
	if ( ! $filepath ) {
		...
		trigger_error( sprintf( esc_html_x( 'Error locating %s for inclusion', 'journals' ), $file ), E_USER_ERROR );
	}
