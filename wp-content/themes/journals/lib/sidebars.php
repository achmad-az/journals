 ...
 *
 * You should just fill the array (or leave an empty array) and journals will do the rest.
...
$sidebars = array(
	// Default sidebar.
	array(
		'name'          => __( 'Default Sidebar', 'journals' ),
		'id'            => 'sidebar-1',
		'description'   => __( 'Add widgets here to appear in your site.', 'journals' ),
