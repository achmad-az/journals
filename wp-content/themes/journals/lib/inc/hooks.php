...
add_action('init', 'journals_custom_post_type', 0); // add custom post type
add_action('init', 'journals_add_custom_taxonomy', 0); // add custom taxonomy
...
function journals_custom_post_type()
{
 ...
 *
 */
function journals_add_custom_taxonomy()
{
    $domain_name = $GLOBALS['domain'];
